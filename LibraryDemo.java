...
public class LibraryDemo {
    ...
    private void printBooks(List<Book> books) {
    	...
    	System.out.print("\n");
    	System.out.println(String.format("%-50s %-20s %-15s %-20s %-15s", "TITLE", "AUTHOR", "ISBN", "DATE", "AGE"));
        for (Book b : books) {
        	String formattedAuthor = null;
        	int years = b.getAge();
        	if(b.getAuthor() != null)
        		formattedAuthor = b.getAuthor().toString();
        	String line = String.format("%-50s %-20s %-15s %-20s %-15s ", b.getTitle(), formattedAuthor, b.getISBN(),
        			b.getPublishDate(), years);
